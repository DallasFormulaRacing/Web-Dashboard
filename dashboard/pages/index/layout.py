...
layout = dmc.MantineProvider(
    ...
    children=[
        ...
        dcc.Store(id="session_id_filter_offline", data=[]),
        dcc.Store(id="offline-data", storage_type="session", data=[]),
        dcc.Store(id="session-id-offline", data=[-1]),
        dcc.Store(id="session-id-current", data=-1),
        dcc.Store(id="is-offline", data=False),
